...
#define ARRAY_SIZE 4000  //initial array size being sent in the network, has to be times of 18 due to different datatype structures
#define STEP 2    //50 array_size*((step-1)*depth + 1) decides the biggest number of integers sent
#define DEPTH 50    //50
#define SKIP 10
#define BLOCKLEN 14
	...
	printf("MPI IMPLEMENTATION, NON/BLK, ITERATION,SIZE,DATA_TYPE,TIME FOR SENDER,BANDWIDTH(MB/s), L1 D CACHE MISS, L2 D CACHE MISS, L3 TOTAL CACHE MISS, D TLB MISS \n");
        for (size_iter = 0; size_iter < STEP; size_iter=size_iter+1){
            //if (size_iter%2 == 0){
                ...
                hard_size = psize*psize*(sizeof(int))/64000; //send actual kbytes
                ...
                printf(MPI_IMP",BLK, %d,%d,Tiled_S2,%.6f, %d, %d, %d, %d, %d\n", IT,psize, t2[size_iter], (int)(hard_size*2/t2[size_iter]), v2[size_iter][0],v2[size_iter][1],v2[size_iter][2],v2[size_iter][3]);
                printf(MPI_IMP",BLK, %d,%d,Tiled_S4,%.6f, %d, %d, %d, %d, %d\n", IT,psize, t3[size_iter], (int)(hard_size*2/t3[size_iter]), v3[size_iter][0],v3[size_iter][1],v3[size_iter][2],v3[size_iter][3]);
                printf(MPI_IMP",BLK, %d,%d,Tiled_S8,%.6f, %d, %d, %d, %d, %d\n", IT,psize, t4[size_iter], (int)(hard_size*2/t4[size_iter]), v4[size_iter][0],v4[size_iter][1],v4[size_iter][2],v4[size_iter][3]);
                printf(MPI_IMP",BLK, %d,%d,Tiled_S16,%.6f, %d, %d, %d, %d, %d\n", IT,psize, t5[size_iter], (int)(hard_size*2/t5[size_iter]), v5[size_iter][0],v5[size_iter][1],v5[size_iter][2],v5[size_iter][3]);
                //printf(MPI_IMP",BLK, %d,%d,STRUCT_S,%.6f\n", IT,array_size*(DEPTH*size_iter+1), t3[size_iter]);
                printf(MPI_IMP",BLK, %d,%d,Tiled_S32,%.6f, %d, %d, %d, %d, %d\n", IT,psize, t6[size_iter], (int)(hard_size*2/t6[size_iter]), v6[size_iter][0],v6[size_iter][1],v6[size_iter][2],v6[size_iter][3]);
                printf(MPI_IMP",BLK, %d,%d,Tiled_S64,%.6f, %d, %d, %d, %d, %d\n", IT,psize, t7[size_iter], (int)(hard_size*2/t7[size_iter]), v7[size_iter][0],v7[size_iter][1],v7[size_iter][2],v7[size_iter][3]);
