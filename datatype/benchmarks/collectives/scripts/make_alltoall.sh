...
mpicc -DMPI_IMP='"MVAPICH2"' -O3 alltoall.c -o alltoall_mvapich2
...
which mpirun
/share/pkg/openmpi/3.1.2_gcc-7.2.0/install/bin/mpicc -DMPI_IMP='"OPEN MPI"' -O3 alltoall.c -o alltoall_ompi
